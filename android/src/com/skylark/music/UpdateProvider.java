...
/**
 * 只服务于「把更新包交给系统安装器」的最小 ContentProvider
 * （等价于自带一个 FileProvider，不用引 AndroidX）。
 */
public class UpdateProvider extends ContentProvider {

    public static final String AUTHORITY = "com.skylark.music.update";
    ...
    public ParcelFileDescriptor openFile(Uri uri, String mode) throws FileNotFoundException {
        File apk = Update.apkFile(getContext());
